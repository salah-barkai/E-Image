...
requirements = python3,kivy==2.1.0,kivymd==0.104.2,pillow==8.3.1,sqlite3
...
presplash.filename = %(source.dir)s/LOGO IMAGE.png

# (str) Icon of the application
icon.filename = %(source.dir)s/LOGO IMAGE.png
